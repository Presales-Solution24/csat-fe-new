    ...
    <MainLayout>
      <Container sx={{ mt: 4 }}>
            ...
            <Table>
              <TableHead sx={{ backgroundColor: "#f0f4f8" }}>
                <TableRow>
                  ...
                  <TableCell sx={{ fontWeight: 600 }}>Kategori Product</TableCell>
                          ...
                          <Collapse in={isOpen} timeout="auto" unmountOnExit>
                            ...
                            >
                              ...
                              {project.tasks && project.tasks.length > 0 ? (
                                <Table size="small">
                                  <TableHead sx={{ backgroundColor: "#e3eaf1" }}>
                                    <TableRow>
                                      <TableCell sx={{ fontWeight: 600 }}>Task</TableCell>
                                      <TableCell sx={{ fontWeight: 600 }}>Expected Result</TableCell>
                                      <TableCell sx={{ fontWeight: 600 }}>Actual Result</TableCell>
                                    </TableRow>
                                  </TableHead>
                                  <TableBody>
                                    {project.tasks.map((task, idx) => (
                                      <TableRow key={idx}>
                                        ...
                                        <TableCell>{task.expected_result}</TableCell>
                                        <TableCell>{task.actual_result}</TableCell>
                                      </TableRow>
                                    ))}
                                  </TableBody>
                                </Table>
        ...
        <Dialog open={deleteDialogOpen} onClose={() => setDeleteDialogOpen(false)}>
          ...
          <DialogContent>
            <DialogContentText>
              Yakin ingin menghapus project ini? Semua task yang terkait juga akan dihapus.
            </DialogContentText>
          </DialogContent>
          <DialogActions>
